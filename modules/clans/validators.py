...
class ClanValidator:
    ...
    async def can_create_clan(self, name: str, leader: Member) -> tuple[bool, Optional[str]]:
    ...
    async def can_manage_clan(self, member: Member, clan: Clan) -> tuple[bool, Optional[str]]:
        return True, None
