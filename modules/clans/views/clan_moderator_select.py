...
class ClanModeratorSelectView(View):
    ...
    def __init__(self, clans: List[FullClan], action_name: str, callback_func: Callable, *args, **kwargs):
    ...
    def _make_callback(self, clan: FullClan):
        async def callback(interaction: Interaction):
            try:
                ...
                await self.callback_func(interaction, clan, *self.callback_args, **self.callback_kwargs)
