...
class AdvancedScheduler:
    ...
    async def calculate_next_runs(self, message_id: str) -> Optional[datetime]:
        ...
        if message.schedule_type == "interval":
            ...
            if (message.hour is not None and 
                message.minute is not None and 
                message.weekdays):
        ...
        if message.schedule_type == "interval":
            ...
            if message.schedule_type == "weekly":
                if not message.weekdays:
                    errors.append("Los días de la semana son obligatorios para programación semanal")
                else:
                    try:
                        import json
                        weekdays = json.loads(message.weekdays)
        ...
        for message in messages:
            ...
            if message.channel_id:
                ...
                if not channel:
                    ...
                    logger.info(
                        ...
                        message.display_name, message.channel_id
                    )
                ...
                if not category:
                    ...
                    logger.info(
                        ...
                        message.display_name, message.category_id
                    )
            ...
            if should_delete:
                ...
                if success:
                    ...
                    logger.error(
                        "Error eliminando mensaje automático %s: %s",
                        message.id, error
                    )
