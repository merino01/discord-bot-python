...
class QueryService(MessageService):
    """Servicio para consultas específicas y filtros de mensajes automáticos"""
    ...
    def get_by_schedule_type(self, schedule_type: str) -> Tuple[Optional[List[AutomaticMessage]], Optional[str]]:
